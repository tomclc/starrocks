...
public:
    ...
    inline static const std::string s2_empty_mark = "S2EMPTYINDEX";
    inline static const int64_t s2_empty_mark_len = 12;
    ...
    static std::string s2_index_file_path(const std::string& rowset_dir, const std::string& rowset_id,
                                            int segment_id, int64_t index_id) {
        // {rowset_dir}/{rowset_id}_{seg_num}_{index_id}.s2.parquet
        return fmt::format("{}/{}_{}_{}.{}", rowset_dir, rowset_id, segment_id, index_id, "s2.parquet");
    }
