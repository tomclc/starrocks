...
struct TS2SearchOptions {
  ...
  6: optional double query_lat;
  7: optional double query_lng;
  8: optional double query_radius_meters;
  9: optional string query_type;  // "point", "circle"
}
...
struct THdfsScanNode {
    ...
    // S2 spatial index search options for external table scans
    26: optional TS2SearchOptions s2_search_options;
    27: optional i64 s2_index_id;
}
